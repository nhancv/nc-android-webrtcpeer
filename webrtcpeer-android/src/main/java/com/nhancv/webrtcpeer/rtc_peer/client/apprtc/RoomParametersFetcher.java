...
package com.nhancv.webrtcpeer.rtc_peer.client.apprtc;

import android.util.Log;

import com.nhancv.webrtcpeer.rtc_comm.tcp.AsyncHttpURLConnection;
import com.nhancv.webrtcpeer.rtc_peer.client.RTCClient;
...
public class RoomParametersFetcher {
    ...
    private void roomHttpResponseParse(String response) {
        ...
        try {
            ...
            RTCClient.SignalingParameters params = new RTCClient.SignalingParameters(
    ...
    public interface RoomParametersFetcherEvents {
         ...
         */
        void onSignalingParametersReady(final RTCClient.SignalingParameters params);
