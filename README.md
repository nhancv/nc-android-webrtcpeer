...
Step 2. Add the dependency
	...
	dependencies {
	        compile 'com.github.nhancv:ot-webrtcpeer-android:{version}'
	}

Ex:
	compile 'com.github.nhancv:ot-webrtcpeer-android:v1.0'
	
Server site: https://github.com/nhancv/ot-kurento-node-webrtc/tree/master/kurento-one2one-call
...
public class MainActivity extends AppCompatActivity implements NWebRTCPeer.Observer {
    ...
    private static final String host = "wss://{host}:{port}/one2one";
